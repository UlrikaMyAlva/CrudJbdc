...
class AppTest {
    ...
    private static final String JDBC_USER = "iths"; //iths
    private static final String JDBC_PASSWORD = "iths"; //iths
    ...
    public static void setUp() throws Exception {
        ...
        //Changed User to the variable TEST_NEWROLE
        con.createStatement().execute("DROP TABLE IF EXISTS " + TEST_NEWROLE);
        con.createStatement().execute("CREATE TABLE " + TEST_NEWROLE + " (ID INT  NOT NULL AUTO_INCREMENT, NAME VARCHAR(255), ROLE VARCHAR(255), PRIMARY KEY (ID))");
    }
